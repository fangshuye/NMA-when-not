...
error_rate <- apply(BE, 2, mean) # Two Type I error rate (without adjustment and with)
...
cat("c1 = ", c1, "\n")
cat("c2 = ", c2, "\n")
cat("Type I error without adjustment", error_rate[1], "\n")
cat("Type I error with adjustment", error_rate[2], "\n")
cat( "=====================================================","\n")
sink()
