...
num_row <- nrow(Output)
Output[num_row+1,] <- c(2021,NA,rbinom(2,50,0.681),50,50)
Output$Study.me[num_row+1] <- 'New Study'
write.csv(Output, 
          file = paste0("./pairwise_dataset_simulated",".csv"))
...
write.csv(dat_para, file = paste0("./res_error_prev_indep_row_",r,".csv"), row.names = F)
